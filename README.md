...
| [tighten-skill](skills/tighten-skill/SKILL.md) | A skill has grown or reads as prose | *"Tighten execute-plan."* Rewrites it in the tight shape with every behaviour kept, then prunes it line by line with you: the line test, headings named for purpose, cross-references checked. |
